          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Raf Adı</th>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Bağlı Olduğu Koridor</th>
                ...
                filteredItems.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                      {item.aisle?.name || '-'} - ({item.aisle?.zone?.name || '-'})
                    </td>
                ...
                <tr>
                  <td colSpan="4" className="px-6 py-12 text-center text-gray-500">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p>{searchQuery || selectedWarehouseId ? 'Aramanızla eşleşen raf bulunamadı.' : 'Henüz hiçbir raf eklenmemiş.'}</p>
                    </div>
                  </td>
                </tr>
              )}
                    ...
                    <div>
                      <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <input
                          ...
                          placeholder="Örn: RAF-A12"
                        />
                        <p className="mt-1 text-[10px] text-gray-500 italic">
                          Sadece büyük harf ve rakam kullanın. Boşluklar otomatik olarak tireye (-) dönüşür. 
                          <span className="block mt-0.5 font-medium">Örn: RAF-A12, R1-S5</span>
                        </p>
                    </div>
                  </div>
